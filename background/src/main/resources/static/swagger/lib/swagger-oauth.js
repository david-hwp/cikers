function handleLogin()
{
    ...
    }), $("button.api-popup-authbtn").unbind(), popupDialog.find("button.api-popup-authbtn").click(function ()
    {
        ...
        var o, i = window.swaggerUi.api.authSchemes, n = window.location,
            ...
            t = n.protocol + "//" + n.host + a + "/o2c.html", p = window.oAuthRedirectUrl || t, r = null, s = [],
            c = popup.find("input:checked"), l = [];
...
{
    var o = e.state, i = window.location, n = location.pathname.substring(0, location.pathname.lastIndexOf("/")),
        a = i.protocol + "//" + i.host + n + "/o2c.html", t = window.oAuthRedirectUrl || a,
        p = {client_id: clientId, code: e.code, grant_type: "authorization_code", redirect_uri: t};
