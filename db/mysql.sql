-- 创建数据库
-- drop DATABASE `cikers`;
create database `cikers` default character set utf8mb4 collate utf8mb4_general_ci;
use cikers;
...
CREATE TABLE `sys_user` (
  ...
  `type` TINYINT(1) COMMENT '0-admin, 1-doctor, 2-organization',
  `relate_user_id` INT(11) COMMENT '关联用户id',
